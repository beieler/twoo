  ...
  def create
    ...
    respond_to do |format|
      if @contribution.save
        format.html { redirect_to([:admin, @contribution], :notice => 'Contribution was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @contribution.update_attributes(params[:contribution])
        format.html { redirect_to([:admin, @contribution], :notice => 'Contribution was successfully updated.') }
        format.xml  { head :ok }
      else
